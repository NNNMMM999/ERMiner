...
public class MainTestRuleGrowth {
	...
	public static void main(String [] arg) throws IOException{
		String input = fileToPath("hairdataMinus.txt");  // the database
		String output = ".//RuleGrConf1HairTop20Show.txt";  // the path for saving the frequent itemsets found
...
//		algo.setMaxConsequentSize(2);  // optional
		...
		// the following lines instead:
		   ...
		   double minsup_absolute = 0.0085;  // it means 75 %
//		   AlgoRULEGROWTH algo = new AlgoRULEGROWTH();
